...
func (f *CIDRFlag) Var() *core.CIDR {
	return f.ptr
}

// Get returns the current value of the flag.
func (f *CIDRFlag) Get() core.CIDR {
	return f.value
}
...
func (f *CIDRFlag) WithDefault(defaultValue core.CIDR) *CIDRFlag {
...
func (f *CIDRFlag) WithValidationCallback(validate func(in core.CIDR) error) *CIDRFlag {
	f.validate = validate
	return f
}
...
func (f *CIDRFlag) set(value core.CIDR) {
	f.value = value
	*f.ptr = value
}
