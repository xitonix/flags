...
func TestInt8Flag_IsRequired(t *testing.T) {
	testCases := []struct {
		title      string
		isRequired bool
	}{
...
func TestInt8Flag_Validation(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			setValidationList: true,
			value:             "104",
			expectedError:     fmt.Sprintf("104 is not an acceptable value for --long. The expected values are %v,%v.", math.MinInt8, math.MaxInt8),
		},
		{
