...
// NewUInt16 creates a new uint16 flag.
func NewUInt16(name, usage string) *UInt16Flag {
	f := &UInt16Flag{
		key:   &Key{},
...
func (f *UInt16Flag) WithShort(short string) *UInt16Flag {
