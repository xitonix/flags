...
// Float64SliceFlag creates a new float64 slice flag.
...
func (f *Float64SliceFlag) WithShort(short string) *Float64SliceFlag {
...
func (f *Float64SliceFlag) Required() *Float64SliceFlag {
	f.isRequired = true
	return f
}
...
func (f *Float64SliceFlag) Key() *Key {
	return f.key
}
