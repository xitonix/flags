...
func TestInt64(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.title, func(t *testing.T) {
			...
			checkFlagInitialState(t, f, "int64", tc.expectedUsage, tc.expectedLong, "")
...
func TestInt64Flag_IsRequired(t *testing.T) {
	testCases := []struct {
		title      string
		isRequired bool
	}{
...
func TestInt64Flag_Set(t *testing.T) {
	testCases := []struct {
		...
		{
			title:         "max int64",
			value:         fmt.Sprintf("%d", math.MaxInt64),
			expectedValue: math.MaxInt64,
		},
		{
			title:         "min int64",
			value:         fmt.Sprintf("%d", math.MinInt64),
...
func TestInt64Flag_Validation(t *testing.T) {
	testCases := []struct {
		title             string
		value             string
		expectedValue     int64
		validationCB      func(in int64) error
		setValidationCB   bool
		validationList    []int64
		...
		},
		{
			...
			validationList:    []int64{100, 101, 102},
			setValidationList: true,
			value:             "104",
		...
		{
			title:             "min and max",
			validationList:    []int64{math.MinInt64, math.MaxInt64},
			setValidationList: true,
			value:             "104",
			expectedError:     fmt.Sprintf("104 is not an acceptable value for --long. The expected values are %v,%v.", math.MinInt64, math.MaxInt64),
		},
		{
